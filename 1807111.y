...
expression: NUM					{ $$ = $1; 	}
	...
	| COS expression ENDCOS { $$ = cos($2*3.1416/180); printf("The value of cos operation : %lf \n", cos($2*3.1416/180)) ; }
	| TAN expression ENDTAN { $$ = tan($2*3.1416/180); printf("The value of tan operation : %lf \n", tan($2*3.1416/180)) ; }
